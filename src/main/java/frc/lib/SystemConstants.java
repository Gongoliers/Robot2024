...
public class SystemConstants {
  ...
  public SystemConstants(
      JointConstants shoulderJointConstants, JointConstants elbowJointConstants) {
  ...
  public SystemConstants(
      ...
      double shoulderMomentOfInertia,
      double shoulderCmRadius,
      double shoulderGearing,
      int shoulderNumMotors,
      double elbowMass,
      double elbowLength,
      double elbowMomentOfInertia,
      double elbowCmRadius,
      double elbowGearing,
      int elbowNumMotors) {
    this(
        new JointConstants(
