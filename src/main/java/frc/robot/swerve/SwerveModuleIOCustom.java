...
public class SwerveModuleIOCustom implements SwerveModuleIO {
    ...
    public SwerveModuleState getState() {
        ...
        return new SwerveModuleState(driveMotorValues.velocityMetersPerSecond, Rotation2d.fromRotations(steerMotorValues.angleRotations));
    }
    ...
    public SwerveModulePosition getPosition() {
        ...
        return new SwerveModulePosition(driveMotorValues.positionMeters, Rotation2d.fromRotations(steerMotorValues.angleRotations));
    }
