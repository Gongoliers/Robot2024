...
public class ShooterFactory {
  ...
  public static VelocityControllerIO createSerializer() {
    if (Robot.isReal() && RobotConstants.REAL_SUBSYSTEMS.contains(Subsystem.SHOOTER)) {
      return new VelocityControllerIOTalonFXPIDF(SerializerConstants.CAN, SerializerConstants.PIDF_CONTROLLER_CONSTANTS);
    }
  ...
  public static VelocityControllerIO createFlywheel() {
    if (Robot.isReal() && RobotConstants.REAL_SUBSYSTEMS.contains(Subsystem.SHOOTER)) {
      return new VelocityControllerIOTalonFXPIDF(FlywheelConstants.CAN, FlywheelConstants.PIDF_CONTROLLER_CONSTANTS);
    }
